...
describe(data) # для всех переменных сразу
describe(data$totsp) # для отдельной переменной
mean(data$totsp)
sd(data$totsp)
...
# Получим модельные значения для модели ценообразования 1 кв м квартиры в Москве
